...
class Dinosaur:
    ...
    def update(self, userInput):
        ...
        if userInput[pygame.K_SPACE] and not self.dino_jump:
            ...
            self.dino_run = False
            self.dino_jump = True
        elif userInput[pygame.K_LSHIFT] and not self.dino_jump:
            self.dino_duck = True
            self.dino_run = False
            self.dino_jump = False
        elif not (self.dino_jump or userInput[pygame.K_LSHIFT]):
            self.dino_duck = False
            self.dino_run = True
            self.dino_jump = False
